...
//		System.out.println(pageInfo.getMaxPage());
	...
	void getBoardByNO() {
		...
		board = service.getBoardByNo(106);
...
//		System.out.println(board);
	...
	void updateBoardTest() {
		...
		board = service.getBoardByNo(127);
		
		board.setTitle("mybatis 게시글 수정2");
		board.setContent("mybatis게시글을 수정하였습니다.2");
		board.setOriginalFilename("test2.txt");
		board.setRenamedFilename("test2.txt");
...
//		System.out.println(board);
	...
	void deleteBoardTest() {
		...
		result = service.delete(127);
		
		assertThat(result).isGreaterThan(0);
		assertThat(service.getBoardByNo(127)).isNull();
	}
